...
import com.github.vitalydev.restaurants.web.dish.DishTestData;
...
public class MenuTestData {
   // public static final MatcherFactory.Matcher<Menu> MENU_MATCHER = MatcherFactory.usingIgnoringFieldsComparator(Menu.class, "restaurant.dishes", "restaurant.votes", "dishesInMenu.id", "dishesInMenu.dish.restId");
    ...
    public static final DishInMenu dish2InMenu = new DishInMenu(DishTestData.dish2);
    public static final DishInMenu dish3InMenu = new DishInMenu(DishTestData.dish3);
    public static final DishInMenu dish1InMenu = new DishInMenu(DishTestData.dish1);
