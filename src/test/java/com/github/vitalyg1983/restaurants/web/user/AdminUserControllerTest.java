package com.github.vitalyg1983.restaurants.web.user;

import com.github.vitalyg1983.restaurants.model.Role;
import com.github.vitalyg1983.restaurants.model.User;
import com.github.vitalyg1983.restaurants.repository.UserRepository;
...
class AdminUserControllerTest extends AbstractControllerTest {
    ...
    private static final String REST_URL = AdminUserController.API_URL + '/';
    ...
    void createDuplicate() throws Exception {
        User expected = new User(null, "New", UserTestData.USER_MAIL, "newPass", 2300, Role.USER, Role.ADMIN);
        perform(MockMvcRequestBuilders.post(REST_URL)
                .contentType(MediaType.APPLICATION_JSON)
