package com.github.vitalydev.restaurants.web;

import com.github.vitalydev.restaurants.error.AppException;
import com.github.vitalydev.restaurants.error.DataConflictException;
import com.github.vitalydev.restaurants.util.validation.ValidationUtil;
...
public class GlobalExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    public ResponseEntity<?> appException(WebRequest request, AppException ex) {
        ...
        return createResponseEntity(request, ex.getOptions(), ValidationUtil.getRootCause(ex).getMessage(), ex.getStatus());
    }

    @ExceptionHandler({EntityNotFoundException.class})
    public ResponseEntity<?> entityNotFoundException(WebRequest request, EntityNotFoundException ex) {
        log.error("EntityNotFoundException: {}", ex.getMessage());
        return createResponseEntity(request, ErrorAttributeOptions.of(EXCEPTION), ValidationUtil.getRootCause(ex).getMessage(), HttpStatus.UNPROCESSABLE_ENTITY);
    }
    ...
    public ResponseEntity<?> dataConflictException(WebRequest request, DataConflictException ex) {
        ...
        return createResponseEntity(request, ErrorAttributeOptions.of(EXCEPTION), ValidationUtil.getRootCause(ex).getMessage(), HttpStatus.CONFLICT);
    }
